...
model = dict(
    ...
    backbone=dict(
        ...
        fast_pathway=dict(
            ...
            pool1_stride_t=1,
            spatial_strides=(1, 2, 2, 1))),
     switch_backbone=dict(
        type='monkey_ResNet3dSlowFast_acar_switch',
        pretrained='/new_data2/ys/checkpoint/SLOWFAST_R50_K400.pth.tar',
        alpha=4,
        beta=0.125,
    ...
    roi_head=dict(
        type='monkey_AVARoIHead_switch_group_swBB',
        bbox_roi_extractor=dict(
            ...
            with_global=False),
        bbox_head=dict(
            type='monkey_BBoxHeadAVA_switch_group_newloss',   
            in_channels=512,
...
log_level = 'INFO'
work_dir = ('/data/ys/mmaction/work_dirs/monkey_BARN/BARN_addFC')

#pre-train
load_from = "/new_data2/ys/checkpoint/slowfast_r50_4x16x1_256e_kinetics400_rgb_20200704-bcde7ed7.pth"  
# load_from = None
# resume_from = "checkpoint/BARR_monkey_58.8.pth"
resume_from = None
