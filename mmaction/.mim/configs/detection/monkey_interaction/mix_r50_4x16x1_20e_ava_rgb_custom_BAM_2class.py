...
model = dict(
    ...
    backbone=dict(
        ...
        pretrained=None,  # 'checkpoint/SLOWFAST_R50_K400.pth.tar'
        alpha=4,
        beta=0.125,
...
work_dir = ('/data/ys/mmaction/work_dirs/monkey_BARN/'
            'interaction_2class_v2')
load_from = '/home/yangsen/mycode/mmaction2-master/checkpoint/SLOWFAST_R50_K400.pth.tar'
# load_from = None
resume_from = None
