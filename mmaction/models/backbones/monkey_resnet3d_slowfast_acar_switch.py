...
class monkey_ResNet3dSlowFast_acar_switch(nn.Module):
    def __init__(self, block=monkey_Bottleneck, layers= [3, 4, 6, 3], alpha=8, beta=0.125, fuse_only_conv=True, fuse_kernel_size=5, slow_full_span=False, pretrained=None):
        super(monkey_ResNet3dSlowFast_acar_switch, self).__init__()
    ...
    def init_weights(self, pretrained=None):
        ...
        if isinstance(self.pretrained, str):
            ...
            '''Fast Network'''
            kaiming_init(self.fast_conv1)
            kaiming_init(self.fast_maxpool)
            kaiming_init(self.fast_res1)
            kaiming_init(self.fast_res2)
            kaiming_init(self.fast_res3)
            kaiming_init(self.fast_res4)
            

            '''Slow Network'''
            kaiming_init(self.slow_conv1)
            kaiming_init(self.slow_maxpool)
            kaiming_init(self.slow_res1)
            kaiming_init(self.slow_res2)
            kaiming_init(self.slow_res3)
            kaiming_init(self.slow_res4)
        else:
...
def slowfast50(**kwargs):
    ...
    """
    model = monkey_ResNet3dSlowFast_acar_switch(monkey_Bottleneck, [3, 4, 6, 3], **kwargs)
    return model
...
def slowfast101(**kwargs):
    ...
    """
    model = monkey_ResNet3dSlowFast_acar_switch(monkey_Bottleneck, [3, 4, 23, 3], **kwargs)
    return model
...
def slowfast152(**kwargs):
    ...
    """
    model = monkey_ResNet3dSlowFast_acar_switch(monkey_Bottleneck, [3, 8, 36, 3], **kwargs)
    return model
...
def slowfast200(**kwargs):
    ...
    """
    model = monkey_ResNet3dSlowFast_acar_switch(monkey_Bottleneck, [3, 24, 36, 3], **kwargs)
    return model


if mmdet_imported:
    MMDET_BACKBONES.register_module()(monkey_ResNet3dSlowFast_acar_switch)