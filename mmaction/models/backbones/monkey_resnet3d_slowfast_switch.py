...
class ResNet3dPathway(ResNet3d):
    ...
    def __init__(self,
                 *args,
                 ...
                 channel_ratio=8,
                 fusion_kernel=5,
                 **kwargs):  # fusion_kernel=5 
        # len(clips)==11 ,  T维度： x_slow: down(11/8)==1   x_fusion(fast): down( (11-K+2*P)/S )+1= down((15-fusion_kernel)/8)+1
        # 令x_slow == x_fusion则  down_sample((15-fusion_kernel)/8) == 0， fusion_kernel>=8
...
class monkey_ResNet3dSlowFast_switch(nn.Module):
    """Slowfast backbone.
...
if mmdet_imported:
    MMDET_BACKBONES.register_module()(monkey_ResNet3dSlowFast_switch)
