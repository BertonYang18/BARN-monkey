...
class monkey_ResNet3dSlowFast_acar(nn.Module):
    def __init__(self, block=monkey_Bottleneck, layers= [3, 4, 23, 3], alpha=8, beta=0.125, fuse_only_conv=True, fuse_kernel_size=5, slow_full_span=False, pretrained=None):
        super(monkey_ResNet3dSlowFast_acar, self).__init__()
...
def slowfast50(**kwargs):
    ...
    """
    model = monkey_ResNet3dSlowFast_acar(monkey_Bottleneck, [3, 4, 6, 3], **kwargs)
    return model
...
def slowfast101(**kwargs):
    ...
    """
    model = monkey_ResNet3dSlowFast_acar(monkey_Bottleneck, [3, 4, 23, 3], **kwargs)
    return model
...
def slowfast152(**kwargs):
    ...
    """
    model = monkey_ResNet3dSlowFast_acar(monkey_Bottleneck, [3, 8, 36, 3], **kwargs)
    return model
...
def slowfast200(**kwargs):
    ...
    """
    model = monkey_ResNet3dSlowFast_acar(monkey_Bottleneck, [3, 24, 36, 3], **kwargs)
    return model


if mmdet_imported:
    MMDET_BACKBONES.register_module()(monkey_ResNet3dSlowFast_acar)