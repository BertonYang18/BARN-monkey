...
class monkey_BBoxHeadAVA_switch_group(nn.Module):
    ...
    def __init__(
        ...
        super(monkey_BBoxHeadAVA_switch_group, self).__init__()
...
if mmdet_imported:
    MMDET_HEADS.register_module()(monkey_BBoxHeadAVA_switch_group)
