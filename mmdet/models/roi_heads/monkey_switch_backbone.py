...
from .monkey_switch_resnet3d import monkey_switch_ResNet3d
...
class monkey_switch_ResNet3dPathway(monkey_switch_ResNet3d):
...
pathway_cfg = {
    'resnet3d': monkey_switch_ResNet3dPathway,
...
class monkey_switch_ResNet3dSlowFast(nn.Module):
    """Slowfast backbone.
