...
class monkey_switch_ResNet3d(nn.Module):
    """ResNet 3d backbone.
...
# @BACKBONES.register_module()
class monkey_switch_ResNet3dLayer(nn.Module):
    """ResNet 3d Layer.
    ...
    def __init__(self,
        ...
        super().__init__()
        self.arch_settings = monkey_switch_ResNet3d.arch_settings
        assert depth in self.arch_settings

        self.make_res_layer = monkey_switch_ResNet3d.make_res_layer
        self._inflate_conv_params = monkey_switch_ResNet3d._inflate_conv_params
        self._inflate_bn_params = monkey_switch_ResNet3d._inflate_bn_params
        self._inflate_weights = monkey_switch_ResNet3d._inflate_weights
        self._init_weights = monkey_switch_ResNet3d._init_weights
...
# if mmdet_imported:
#     MMDET_SHARED_HEADS.register_module()(monkey_switch_ResNet3dLayer)
#     MMDET_BACKBONES.register_module()(monkey_switch_ResNet3d)
