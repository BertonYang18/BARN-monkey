...
def parse_args():
    ...
    parser.add_argument('--config', default="configs/detection/monkey/slowfast_kinetics_pretrained_r50_4x16x1_20e_ava_rgb.py",help='train config file path')
    parser.add_argument('--master_port', type=int, default=29800)
